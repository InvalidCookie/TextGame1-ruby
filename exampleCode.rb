#creates an empty array for the users inventory
@inventory = []
...
def help()
  ...
  puts "go (direction): move in the direction specified."
  ...
  puts "use: use an item in your inventory on an object."
...
# the following methods define various rooms in the dungeon
def chest_room
  if @key_present
